...
print("xgb vanilla score :- ", xgb_score)

print("xgb vanilla confusion matrix :-")
print("===============================")
print(xgb_cm)

print("xgb vanilla classification report :-")
print("=====================================")
print(xgb_cr)
...
print("xgb tuned accuracy score :- ",clf_score)

print("xgb tuned confusion matrix :-")
print("===============================")
print(clf_cm)

print("xgb tuned classification report :-")
print("=====================================")
print(clf_cr)
